...
export type CreateCommentInput = {
  id?: string | null,
  commentOwnerId: string | undefined,
  commentOwnerUsername: string | undefined,
  content: string,
  createdAt?: string | null,
...
export type CreateLikeInput = {
  id?: string | null,
  numberLikes: number,
  likeOwnerId: string | undefined,
  likeOwnerUsername: string | undefined,
